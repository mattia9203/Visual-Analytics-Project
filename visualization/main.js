...
const AUDIO_FEATURES = ["danceability", "energy", "loudness", "speechiness", "acousticness", "instrumentalness", "liveness", "valence", "popularity", "Year", "Sampled_By", "Is_Sample", "Covered_By_", "Is_Cover" , "Remixed_By" ,"Is_Remix", "tsne_x", "tsne_y"]; // <--- ADD TSNE COLUMNS HERE
